...
const SignUpModal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let URL =
      "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBNwtkSjxIurVk026d4bEzSu7W4c6bZ-Wc";
    if (isSignIn) {
      URL =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBNwtkSjxIurVk026d4bEzSu7W4c6bZ-Wc";
    }
    ...
    <>
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Nav
            variant="pills"
            defaultActiveKey={isSignIn ? "sign-in" : "sign-up"}
          >
            <Nav.Item>
